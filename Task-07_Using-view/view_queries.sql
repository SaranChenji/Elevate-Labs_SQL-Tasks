...
select * from students where student_name like '%sar%';
...
select * from registration order by registration_date asc limit 2;
...
create view students_without_email as
select student_name, dob
from students
where email is null;

select * from student_course_details;
select * from course_registration_summary;
select * from female_students;
select * from students_without_email;
